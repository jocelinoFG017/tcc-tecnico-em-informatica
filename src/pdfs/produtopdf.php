...
$pdf->Cell(0,5,iconv('UTF-8','ISO-8859-1//TRANSLIT',"Relatório de Produtos"),0,1,'C');
$pdf->Ln(15);
$pdf->Cell(0,5,"","B",1,'C');
$pdf->Ln(50);
...
$pdf->Cell(140,20,iconv('UTF-8','ISO-8859-1//TRANSLIT','Descrição'),1,0,"L");
$pdf->Cell(100,20,'Marca',1,0,"L");
$pdf->Cell(100,20,'Quantidade',1,0,"L");
$pdf->Cell(70,20,iconv('UTF-8','ISO-8859-1//TRANSLIT','Preço R$'),1,0,"L");
...
while ($resultado = mysqli_fetch_array($busca)) {
    ...
    $pdf->Cell(140,20,iconv('UTF-8','ISO-8859-1//TRANSLIT',$resultado['descricao']),1,0,"L");
