                           ...
                           <div class="card-body">
                              ...
                              <form action="../Cadastrar/cadastroUsuario.php" method="POST">
                                 <div class="position-relative row form-group">
                                    ...
                                    <div class="col-sm-10"><input required name="nome" placeholder="Nome(ex:Joao da silva)" type="text" class="form-control"></div>
                                 </div>
                                 <div class="position-relative row form-group">
                                    <label for="exampleEmail" class="col-sm-2 col-form-label">Email:</label>
                                    <div class="col-sm-10"><input required name="login" placeholder="Email (ex:joaoSilva@email.com)" type="text" class="form-control"></div>
                                 </div>
                                 <div class="position-relative row form-group">
                                    <label for="examplePassword" class="col-sm-2 col-form-label">Senha:</label>
                                    <div class="col-sm-10"><input required name="senha" placeholder="Senha(faça uma senha forte com numeros e letras)" type="password" class="form-control"></div>
                                 </div>
