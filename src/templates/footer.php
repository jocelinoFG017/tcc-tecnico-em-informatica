        ...
        <div class="row justify-content-center align-items-start text-start">
            ...
            <div class="col-md-2 col-6 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="../pages/faq.php" class="text-light text-decoration-none">FAQ’s</a></li>
                </ul>
            </div>
            ...
            <div class="col-md-2 col-6 mb-4">
                ...
                <ul class="list-unstyled">
                    <li><a href="../pages/termosDeUso.php" class="text-light text-decoration-none">Termos de Uso</a></li>
                    <li><a href="../pages/politicaPrivacidade.php" class="text-light text-decoration-none">Política de Privacidade</a></li>
                </ul>
            </div>
