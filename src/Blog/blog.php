            ...
            <div class="row">
               <div class="col-sm-3">
                  <div class="left-sidebar">
                     ...
                     <div class="panel-group category-products" id="accordian">
                        ...
                        <div class="panel panel-default">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a href="#">Sobre Peixes</a></h4>
                           </div>
                        </div>
                        <div class="panel panel-default">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a href="#">Sobre Pássaros</a></h4>
                           </div>
                        </div>
                     </div>
                     <!--/category-products-->
                     <div class="shipping text-center">
                        <!--shipping-->
                        <img src="imagens/home/pexe.jpg" alt="" />
                     </div>
                     <!--/shipping-->
                  </div>
               </div>
               <div class="col-sm-9">
                  <div class="blog-post-area">
                     <h2 class="title text-center">Area do Blog</h2>
                     <div class="single-blog-post">
                        ...
                        <a href="">
                        <img src="imagens/blog/blog-one.jpg" alt="">
                        </a>
                        <p>
                  ...
                  <div class="media commnets">
                     ...
                     <img class="media-object" src="imagens/blog/man-one.jpg" alt="">
                     </a>
